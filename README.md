...
当前为 `0.1.2` 早期版本，支持 Android 10 及以上。前往 [GitHub Releases](https://github.com/randi0818/reason-app/releases/latest) 下载正式签名的 `reason-app-0.1.2.apk`，同页提供 `SHA256SUMS.txt` 校验文件。自行构建方法见下方「本地构建」。
